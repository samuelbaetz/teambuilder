...
const renderManager = manager => {
  ...
  template = replacePlaceholders(template, "numofsuper", manager.getnumofsuper());
  return template;
};
...
const renderIntern = intern => {
  ...
  template = replacePlaceholders(template, "uni", intern.getUni());
  return template;
};
...
const renderMain = html => {
  ...
  const mainHTML = replacePlaceholders(template, "team", html);
    ...
    fs.writeFileSync(file, mainHTML);
};
